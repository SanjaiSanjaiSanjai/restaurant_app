import { category_repo, menus_items_repo, menus_repo, refresh_token_repo, user_repo } from "../repositary/repositary"

export const ALLOWED_TABLES = ['Users','RefreshToken','Categories','Menu_items','Menu'] as const
